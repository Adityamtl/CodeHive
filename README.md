# **CodeHive - Your Classroom, Compiler, and Community in One Place** 

**CodeHive** is a comprehensive web platform where users can code, compile, chat, and share their screens seamlessly. Designed to empower collaborative learning, CodeHive is perfect for teachers and students to conduct live coding classes, interact, and learn together in real-time.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/dibakarghosh03/codehive.git
...
## 🌐 Live Demo  
Experience CodeHive live: [CodeHive Live](https://codehive-editor.vercel.app/)
